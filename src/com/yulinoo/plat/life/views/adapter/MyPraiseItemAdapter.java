...
public class MyPraiseItemAdapter extends YuLinooLoadAdapter<MessageCenterInfo> implements OnClickListener{
	private LayoutInflater inflater;
	private MyApplication myapp;
	private Context mContext;
	private Account me;
	public MyPraiseItemAdapter(Context context) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			if (item!=null) {
				convertView = inflater.inflate(R.layout.my_praise_list_item, parent,false);
		...
		if (item!=null) {
			...
			}else
			{
				...
				holder.comment_direction_desc.setText(R.string.someone_praise_you);
			}
