...
public class MerchantCommentItemAdapter extends YuLinooLoadAdapter<MessageCenterInfo> implements OnClickListener,XListView.IXListViewListener{
	...
	public MerchantCommentItemAdapter(Context context) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			if (item!=null) {
				convertView = inflater.inflate(R.layout.merchant_comment_list_item, parent,false);
		...
		if (item!=null) {
			...
			}else
			{
				...
				holder.comment_direction_desc.setText("发布了评论");
			}
