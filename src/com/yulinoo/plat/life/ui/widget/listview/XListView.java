package com.yulinoo.plat.life.ui.widget.listview;
...
public class XListView extends ListView implements OnScrollListener {
	...
	private boolean isLoadLoading=false;
	...
	private void initWithContext(Context context) {
		...
		mHeaderHeight=(int)context.getResources().getDimension(R.dimen.header_height);
